...
def compute_segment(sup_or_jux,sex,species,sup_or_multi,diabete,inhib,unx,preg,HT,HCa,file_to_save):
    ...
    if sup_or_jux != 'sup':
        ...
        if sex == 'Male':
            ...
            filename ='./datafiles/LDLparams_F_'+species[0:3]+'.dat'
        ldl, fluxvals_ldl =compute(NLDL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT = HT, HCa=HCa)
    ...
    #========================================================
        ...
        if sex == 'Male':
            ...
            filename ='./datafiles/LALparams_F_rat.dat'
        lal, fluxvals_lal =compute(NLAL,filename,'Newton' ,sup_or_jux,diabete,species,sup_or_multi=sup_or_multi,inhibition = inhib,unx = unx, preg = preg, HT = HT, HCa=HCa)
