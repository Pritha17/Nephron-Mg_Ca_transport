...
N=200
# physical constants
RT    = 2.57 # J/mmol; R = 8.135 J K-1 mol-1, T = temperature in K (273 + temp in Celcius)
RTosm = 1.93e4
F     = 96.5    # C/mmol
visc  = 6.4e-6
...
TotcaPap_100NKCCinhib = 1.25

TotcaOI_50inhib = TotcaOI_noinhib
TotcaPap_50inhib = 3.0

TotucaOI_80inhib = TotcaOI_noinhib
TotucaPap_80inhib = 3.0

# Mg2+
TotmgOI_noinhib = 0.96
TotmgOI_70NKCCinhib = 0.905 #0.72
TotmgOI_100NKCCinhib = 0.85 #0.48

TotmgPap_noinhib = 1.54
TotmgPap_70NKCCinhib = 1.01
TotmgPap_100NKCCinhib = 0.48

TotmgOI_50inhib = TotmgOI_noinhib
TotmgPap_50inhib = 1.155

TotumgOI_80inhib = TotmgOI_noinhib
TotumgPap_80inhib = 1.155
